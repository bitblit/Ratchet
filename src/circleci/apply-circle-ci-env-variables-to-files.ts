...
export class ApplyCircleCiEnvVariablesToFiles {
    ...
    public static async process(fileNames: string[], timezone: string='America/Los_Angeles',
                                                       buildFinder: string = 'LOCAL-SNAPSHOT',
                                                       branchFinder: string = 'LOCAL-BRANCH',
                                                       hashFinder: string = 'LOCAL-HASH',
                                                       tagFinder: string = 'LOCAL-TAG',
                                                       timeFinder: string = 'LOCAL-TIME'
                                                       ): Promise<number> {
