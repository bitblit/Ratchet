...
export function UserFromJSONTyped(json: any, ignoreDiscriminator: boolean): User {
  ...
  return {
    ...
    localIdentities: !exists(json, 'localIdentities')
      ? undefined
      : (json['localIdentities'] as Array<any>).map(UserLocalIdentitiesInnerFromJSON),
  };
}
...
export function UserToJSON(value?: User | null): any {
  ...
  return {
    ...
    localIdentities:
      value.localIdentities === undefined ? undefined : (value.localIdentities as Array<any>).map(UserLocalIdentitiesInnerToJSON),
  };
}
