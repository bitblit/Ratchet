...
export interface SendersApiInterface {
   ...
   */
  createSenderRaw(
    requestParameters: CreateSenderRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<CreateSenderModel>>;
   ...
   */
  deleteSenderRaw(
    requestParameters: DeleteSenderRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   */
  getIpsFromSenderRaw(
    requestParameters: GetIpsFromSenderRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<GetIpsFromSender>>;
   ...
   */
  getSendersRaw(
    requestParameters: GetSendersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<GetSendersList>>;
   ...
   */
  updateSenderRaw(
    requestParameters: UpdateSenderRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>>;
...
export class SendersApi extends runtime.BaseAPI implements SendersApiInterface {
  ...
  async deleteSenderRaw(
    ...
    if (requestParameters.senderId === null || requestParameters.senderId === undefined) {
      throw new runtime.RequiredError(
        'senderId',
        'Required parameter requestParameters.senderId was null or undefined when calling deleteSender.',
      );
    }
  ...
  async getIpsFromSenderRaw(
    ...
    if (requestParameters.senderId === null || requestParameters.senderId === undefined) {
      throw new runtime.RequiredError(
        'senderId',
        'Required parameter requestParameters.senderId was null or undefined when calling getIpsFromSender.',
      );
    }
  ...
  async updateSenderRaw(
    ...
    if (requestParameters.senderId === null || requestParameters.senderId === undefined) {
      throw new runtime.RequiredError(
        'senderId',
        'Required parameter requestParameters.senderId was null or undefined when calling updateSender.',
      );
    }
