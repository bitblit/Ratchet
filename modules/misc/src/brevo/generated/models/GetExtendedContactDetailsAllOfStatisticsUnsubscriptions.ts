...
export function GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsFromJSON(
  json: any,
...
export function GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsFromJSONTyped(
  json: any,
...
export function GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsToJSON(
  value?: GetExtendedContactDetailsAllOfStatisticsUnsubscriptions | null,
): any {
  if (value === undefined) {
    return undefined;
  }
