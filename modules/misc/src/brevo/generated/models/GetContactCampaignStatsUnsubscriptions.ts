...
export function GetContactCampaignStatsUnsubscriptionsFromJSONTyped(
  json: any,
  ...
  return {
    userUnsubscription: (json['userUnsubscription'] as Array<any>).map(
      GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscriptionFromJSON,
    ),
    adminUnsubscription: (json['adminUnsubscription'] as Array<any>).map(
      GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscriptionFromJSON,
    ),
  };
}
...
export function GetContactCampaignStatsUnsubscriptionsToJSON(value?: GetContactCampaignStatsUnsubscriptions | null): any {
  ...
  return {
    userUnsubscription: (value.userUnsubscription as Array<any>).map(
      GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscriptionToJSON,
    ),
    adminUnsubscription: (value.adminUnsubscription as Array<any>).map(
      GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscriptionToJSON,
    ),
  };
}
