...
export function GetExtendedContactDetailsAllOfStatisticsFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetExtendedContactDetailsAllOfStatistics {
    ...
    return {
        ...
        'unsubscriptions': !exists(json, 'unsubscriptions') ? undefined : GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsFromJSON(json['unsubscriptions']),
        'opened': !exists(json, 'opened') ? undefined : ((json['opened'] as Array<any>).map(GetExtendedContactDetailsAllOfStatisticsOpenedFromJSON)),
        'clicked': !exists(json, 'clicked') ? undefined : ((json['clicked'] as Array<any>).map(GetExtendedContactDetailsAllOfStatisticsClickedFromJSON)),
...
export function GetExtendedContactDetailsAllOfStatisticsToJSON(value?: GetExtendedContactDetailsAllOfStatistics | null): any {
    ...
    return {
        ...
        'clicked': value.clicked === undefined ? undefined : ((value.clicked as Array<any>).map(GetExtendedContactDetailsAllOfStatisticsClickedToJSON)),
