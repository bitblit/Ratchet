...
export class ResellerApi extends runtime.BaseAPI implements ResellerApiInterface {
     ...
     * Add Email and/or SMS credits to a specific child account
     */
    async addCreditsRaw(requestParameters: AddCreditsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RemainingCreditModel>> {
     ...
     * Add Email and/or SMS credits to a specific child account
     */
    async addCredits(requestParameters: AddCreditsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RemainingCreditModel> {
     ...
     * Associate a dedicated IP to the child
     */
    async associateIpToChildRaw(requestParameters: AssociateIpToChildRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.childIdentifier === null || requestParameters.childIdentifier === undefined) {
     ...
     * Associate a dedicated IP to the child
     */
    async associateIpToChild(requestParameters: AssociateIpToChildRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     * Create a domain for a child account
     */
    async createChildDomainRaw(requestParameters: CreateChildDomainRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.childIdentifier === null || requestParameters.childIdentifier === undefined) {
     ...
     * Create a domain for a child account
     */
    async createChildDomain(requestParameters: CreateChildDomainRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     * Creates a reseller child
     */
    async createResellerChildRaw(requestParameters: CreateResellerChildRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateReseller>> {
        const queryParameters: any = {};
     ...
     * Creates a reseller child
     */
    async createResellerChild(requestParameters: CreateResellerChildRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateReseller> {
     ...
     * Delete the sender domain of the reseller child based on the childIdentifier and domainName passed
     */
    async deleteChildDomainRaw(requestParameters: DeleteChildDomainRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.childIdentifier === null || requestParameters.childIdentifier === undefined) {
        ...
        const response = await this.request({
            path: `/reseller/children/{childIdentifier}/domains/{domainName}`.replace(`{${"childIdentifier"}}`, encodeURIComponent(String(requestParameters.childIdentifier))).replace(`{${"domainName"}}`, encodeURIComponent(String(requestParameters.domainName))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Delete the sender domain of the reseller child based on the childIdentifier and domainName passed
     */
    async deleteChildDomain(requestParameters: DeleteChildDomainRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     * Delete a single reseller child based on the child identifier supplied
     */
    async deleteResellerChildRaw(requestParameters: DeleteResellerChildRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.childIdentifier === null || requestParameters.childIdentifier === undefined) {
     ...
     * Delete a single reseller child based on the child identifier supplied
     */
    async deleteResellerChild(requestParameters: DeleteResellerChildRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     * Dissociate a dedicated IP to the child
     */
    async dissociateIpFromChildRaw(requestParameters: DissociateIpFromChildRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.childIdentifier === null || requestParameters.childIdentifier === undefined) {
     ...
     * Dissociate a dedicated IP to the child
     */
    async dissociateIpFromChild(requestParameters: DissociateIpFromChildRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     * Get the status of a reseller\'s child account creation, whether it is successfully created (exists) or not based on the childIdentifier supplied
     */
    async getChildAccountCreationStatusRaw(requestParameters: GetChildAccountCreationStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetChildAccountCreationStatus>> {
        if (requestParameters.childIdentifier === null || requestParameters.childIdentifier === undefined) {
     ...
     * Get the status of a reseller\'s child account creation, whether it is successfully created (exists) or not based on the childIdentifier supplied
     */
    async getChildAccountCreationStatus(requestParameters: GetChildAccountCreationStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetChildAccountCreationStatus> {
     ...
     * Get all sender domains for a specific child account
     */
    async getChildDomainsRaw(requestParameters: GetChildDomainsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<GetChildDomain>>> {
        if (requestParameters.childIdentifier === null || requestParameters.childIdentifier === undefined) {
     ...
     * Get all sender domains for a specific child account
     */
    async getChildDomains(requestParameters: GetChildDomainsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<GetChildDomain>> {
     ...
     * Get a child account\'s details
     */
    async getChildInfoRaw(requestParameters: GetChildInfoRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetChildInfo>> {
        if (requestParameters.childIdentifier === null || requestParameters.childIdentifier === undefined) {
     ...
     * Get a child account\'s details
     */
    async getChildInfo(requestParameters: GetChildInfoRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetChildInfo> {
     ...
     * Get the list of all children accounts
     */
    async getResellerChildsRaw(requestParameters: GetResellerChildsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetChildrenList>> {
        const queryParameters: any = {};
     ...
     * Get the list of all children accounts
     */
    async getResellerChilds(requestParameters: GetResellerChildsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetChildrenList> {
     ...
     * Get session token to access Sendinblue (SSO)
     */
    async getSsoTokenRaw(requestParameters: GetSsoTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSsoToken>> {
        if (requestParameters.childIdentifier === null || requestParameters.childIdentifier === undefined) {
     ...
     * Get session token to access Sendinblue (SSO)
     */
    async getSsoToken(requestParameters: GetSsoTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSsoToken> {
     ...
     * Remove Email and/or SMS credits from a specific child account
     */
    async removeCreditsRaw(requestParameters: RemoveCreditsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RemainingCreditModel>> {
        if (requestParameters.childIdentifier === null || requestParameters.childIdentifier === undefined) {
     ...
     * Remove Email and/or SMS credits from a specific child account
     */
    async removeCredits(requestParameters: RemoveCreditsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RemainingCreditModel> {
     ...
     * Update info of reseller\'s child account status based on the identifier supplied
     */
    async updateChildAccountStatusRaw(requestParameters: UpdateChildAccountStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.childIdentifier === null || requestParameters.childIdentifier === undefined) {
     ...
     * Update info of reseller\'s child account status based on the identifier supplied
     */
    async updateChildAccountStatus(requestParameters: UpdateChildAccountStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     * Update the sender domain of reseller\'s child based on the childIdentifier and domainName passed
     */
    async updateChildDomainRaw(requestParameters: UpdateChildDomainRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.childIdentifier === null || requestParameters.childIdentifier === undefined) {
     ...
     * Update the sender domain of reseller\'s child based on the childIdentifier and domainName passed
     */
    async updateChildDomain(requestParameters: UpdateChildDomainRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     * Update info of reseller\'s child based on the child identifier supplied
     */
    async updateResellerChildRaw(requestParameters: UpdateResellerChildRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.childIdentifier === null || requestParameters.childIdentifier === undefined) {
     ...
     * Update info of reseller\'s child based on the child identifier supplied
     */
    async updateResellerChild(requestParameters: UpdateResellerChildRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
