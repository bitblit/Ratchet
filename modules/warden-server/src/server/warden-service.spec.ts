...
describe('#WardenService', () => {
  beforeEach(() => {
    ...
    opts = {
      ...
      jwtRatchet: new JwtRatchet({encryptionKeyPromise:Promise.resolve('asdf'), jwtLibPromise: JwtRatchet.dynamicallyLoadLibraryDefaultExportAsJwtLibLike('jsonwebtoken')}), //mockJwtRatchet,
